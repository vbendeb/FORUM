...
strRqMethod = "EditTopic" or strRqMethod = "Topic" or strRqMethod = "TopicQuote" then 
	...
	strRqMethod = "Topic" or strRqMethod = "EditTopic" or strRqMethod = "TopicQuote" then 
		...
		strRqMethod = "ReplyQuote" or strRqMethod = "TopicQuote") then
			if strStickyTopic = "1" then
				if strRqMethod = "Topic" then
					Response.Write	"                <font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """><input name=""sticky"" type=""checkbox"" value=""1"">Check here to make this topic sticky.<br /></font>" & vbNewLine
				elseif strRqMethod = "EditTopic" then
			...
			if blnTStatus = 1 then
				if strRqMethod <> "EditTopic" then
					Response.Write	"                <font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """><input name=""lock"" type=""checkbox"" value=""1"">Check here to lock the topic after this post.<br /></font>" & vbNewLine
				end if
			end if
		end if
