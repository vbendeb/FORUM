...
if strProhibitNewMembers <> "1" then
	Response.Write	"      <table border=""0"" width=""100%"" cellspacing=""0"" cellpadding=""0"" align=""center"">" & vbNewLine & _
			...
			"1. После нажатия кнопки &quot;Регистрация&quot; Ваш запрос посылается на MOCT.<BR> " & _
			"2. Регистрационное сообщение будет послано автоматически на Ваш E-mail адрес со спец.линком на Форум.<BR> " & _
			"3. Проверьте свой E-mail почтовый ящик, получите и откройте регистрационное сообщение.<BR> " & _
			"4. Нажмите (кликайте) на спец.линк в рег. сообщении, и он приведет Вас назад на Форум, при этом активируя Ваш логин.<BR> " & _
			"5. Шаг №4 подтверждает правильность Вашего E-mail адреса. Если адрес неправильный, процесс остановится на №3.<BR> " & _
			" <BR> " & _
			...
			"</ol>" & _
			"</p>" & vbNewLine & _
			"                <p>Если Вы согласны с Правилами Форума изложенными выше, пожалуйста нажмите кнопку &quot;Регистрация&quot;, в противном случае нажмите кнопку &quot;Отмена&quot;.</p>" & vbNewLine & _
			...
			"                        <input name=""Submit"" type=""Submit"" value=""Регистрация"">" & vbNewLine & _
			"                        </form>" & vbNewLine & _
			"                        </td>" & vbNewLine & _
			"                        <td>" & vbNewLine & _
