...
Response.Write	"<style><!--" & vbNewline & _
		...
		"</head>" & vbNewline & _
		vbNewline & _
		"<body bgColor=""" & strPageBGColor & """ text=""" & strDefaultFontColor & """ link=""" & strLinkColor & """ aLink=""" & strActiveLinkColor & """ vLink=""" & strActiveLinkColor & """ onLoad=""window.focus();"">" & vbNewline & _
		vbNewline & _
