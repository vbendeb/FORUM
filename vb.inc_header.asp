...
sub sForumNavigation()
	...
	strMoctUrl = strHomeURL & "?UserID=" & StrHexDecoder(Request.Cookies(strUniqueID & "User")("Name"))
...
//	Response.Write	"          <a href=""" & strHomeURL & """" & dWStatus("Homepage") & " tabindex=""-1""><acronym title=""Homepage"">MOCT.org</acronym></a>" & vbNewline & _
